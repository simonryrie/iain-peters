...
export const quotes: Quote[] = [
	...
	},
	{
		...
		turning away from the prescribed English boarding school route to Cambridge, and all the
		adventures that followed. There is a <b>universal quality to the writing, which makes it
		widely accessible</b> and gives voice - and hope - to the men and women who have
		experiences that echo Iain Peters’ own but struggle to articulate those dark places."`,
